...
NDiplomacy = {
	...
	BASE_IMPROVE_RELATION_SAME_IDEOLOGY_GROUP_MAINTAIN_COST = 5.2, -- Political power cost each update when boosting relations with nation of same ideology
	...
	BASE_SEND_ATTACHE_CP_COST = 1300.0,				-- Command Power sent attache usage cost
	BASE_GENERATE_WARGOAL_DAILY_PP = 5.2,	-- Daily pp cost for generation of wargoals
	WARGOAL_VERSUS_MAJOR_AT_WAR_REDUCTION = -19.5, 	-- reduction of pp cost for wargoal vs major at war.
	WARGOAL_WORLD_TENSION_REDUCTION = -13,			-- Reduction of pp cost for wargoal at 100% world tension, scales linearly
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_PP = 6.5, 	-- Daily pp cost for boost party popularity
	BASE_BOOST_PARTY_POPULARITY_DAILY_DRIFT = 0.1, 	-- Daily amount of popularity that will be added by the activity.
	BASE_STAGE_COUP_DAILY_PP = 13,					-- Daily pp cost for staging a coup
	...
	GUARANTEE_COST = 650,							-- Scale with the number of already guaranteed countries.
	REVOKE_GUARANTEE_COST = 650,
...
NCountry = {
	...
	POLITICAL_POWER_CAP = 2100000.0,					-- Max amount of political power country should have
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 52,	-- Weekly increase of PP.
